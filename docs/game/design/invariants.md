...
- The play space is entirely procedural. Only UI icons, branding, and out-of-game marketing art may be authored.
- Form encodes function: fill for identity, outline/ring for allegiance, silhouette for class/type, and standardized shapes for telegraphs.
- Every hue-coded distinction has a non-hue cue.

Topic documents may explain a rule's local consequence, but this file owns its global wording.

...
- **Vision and aim disruption:** smoke breaks line of sight; flashbangs disrupt aim. These excel against other Gunslingers but are weaker against forgiving, ground-targeted magic.
  - A **smoke canister** is thrown and leaves a standing cloud for a fixed window. The cloud blocks line of sight without becoming physical collision: bullets, blasts, and bodies still pass straight through. Players and projectiles whose complete silhouette lies in its sight shadow stop reaching the viewer's snapshot, while any exposed edge retains the entity. Two bodies close enough to touch keep the authored reveal exception so a contact fight inside smoke remains readable.
